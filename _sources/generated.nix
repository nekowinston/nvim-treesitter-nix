...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  nvim-treesitter = {
    ...
    version = "845356a256ed6ff5868da582cb62a31d762e1804";
    src = fetchgit {
      url = "https://github.com/nvim-treesitter/nvim-treesitter";
      rev = "845356a256ed6ff5868da582cb62a31d762e1804";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-rBoVO4CKJ65j4jqTm/J+Cn4pFUV1gcpZjS63RBBN9Pc=";
    };
    date = "2025-03-16";
  };
  ...
  treesitter-grammar-verilog = {
    ...
    version = "f6be2c3c1d6c73a06c70b797631a02c90b133360";
    src = fetchFromGitHub {
      owner = "gmlarumbe";
      repo = "tree-sitter-systemverilog";
      rev = "f6be2c3c1d6c73a06c70b797631a02c90b133360";
      fetchSubmodules = false;
      sha256 = "sha256-hxacduvnal35jX1Fvrs8I5CYi8aF8EolKxtWri8NemI=";
    };
    isGrammar = "true";
    date = "2025-03-14";
  };
  ...
  treesitter-grammar-ziggy = {
    ...
    version = "cfc661821e387f7b48b1db0408fe8219d1ca611d";
    src = fetchFromGitHub {
      owner = "kristoff-it";
      repo = "ziggy";
      rev = "cfc661821e387f7b48b1db0408fe8219d1ca611d";
      fetchSubmodules = false;
      sha256 = "sha256-y+FhADOqq/InGv95LtW8GIUDWFqEC/bN+sinCMh2iL8=";
    };
